...
func (sv *SyncValidator) Validate() error {
	...
	if err != nil {
		return errors.Wrap(err, "converting quorum data to qubic format")
	}
	...
	if err != nil {
		return errors.Wrap(err, "converting tick data to qubic format")
	}
	...
	if err != nil {
		return errors.Wrap(err, "converting transactions to qubic format")
	}
