...
func TestQubicModelToProto(t *testing.T) {
	...
	mockData := types.QuorumVotes{
		types.QuorumTickVote{
			...
			PreviousTransactionBodyDigest: 987654321,
			SaltedTransactionBodyDigest:   123456789,
	...
	expectedProtoQuorumTickData := &protobuff.QuorumTickData{
		QuorumTickStructure: &protobuff.QuorumTickStructure{
			...
			PrevResourceTestingDigestHex: convertUint32ToHex(123456789),
			PrevTransactionBodyHex:       convertUint32ToHex(987654321),
		...
		QuorumDiffPerComputor: map[uint32]*protobuff.QuorumDiff{
			1: {
				SaltedResourceTestingDigestHex: convertUint32ToHex(987654321),
				SaltedTransactionBodyHex:       convertUint32ToHex(123456789),
			...
			3: {
				SaltedResourceTestingDigestHex: convertUint32ToHex(987651321),
				SaltedTransactionBodyHex:       convertUint32ToHex(123456789),
