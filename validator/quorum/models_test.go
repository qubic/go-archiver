...
func TestQubicModelToProto(t *testing.T) {
	...
	mockData := types.ResponseQuorumTickData{
	...
	expectedProtoQuorumTickData := &protobuff.QuorumTickData{
		QuorumTickStructure: &protobuff.QuorumTickStructure{
			...
			PrevSpectrumDigestHex:        fillStringTo(64, hex.EncodeToString(mockData.QuorumData[0].PreviousSpectrumDigest[:])),
			PrevUniverseDigestHex:        fillStringTo(64, hex.EncodeToString(mockData.QuorumData[0].PreviousUniverseDigest[:])),
			PrevComputerDigestHex:        fillStringTo(64, hex.EncodeToString(mockData.QuorumData[0].PreviousComputerDigest[:])),
		...
		QuorumDiffPerComputor: map[uint32]*protobuff.QuorumDiff{
			1: {
				...
				SaltedSpectrumDigestHex:        fillStringTo(64, hex.EncodeToString(mockData.QuorumData[0].SaltedSpectrumDigest[:])),
				SaltedUniverseDigestHex:        fillStringTo(64, hex.EncodeToString(mockData.QuorumData[0].SaltedUniverseDigest[:])),
				SaltedComputerDigestHex:        fillStringTo(64, hex.EncodeToString(mockData.QuorumData[0].SaltedComputerDigest[:])),
			...
			3: {
				...
				SaltedSpectrumDigestHex:        fillStringTo(64, hex.EncodeToString(mockData.QuorumData[1].SaltedSpectrumDigest[:])),
				SaltedUniverseDigestHex:        fillStringTo(64, hex.EncodeToString(mockData.QuorumData[1].SaltedUniverseDigest[:])),
				SaltedComputerDigestHex:        fillStringTo(64, hex.EncodeToString(mockData.QuorumData[1].SaltedComputerDigest[:])),
	...
	result := qubicModelToProto(&mockData)
