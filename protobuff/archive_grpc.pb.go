...
const (
	...
	ArchiveService_GetQuorumVotes_FullMethodName                 = "/qubic.archiver.archive.pb.ArchiveService/GetQuorumVotes"
...
type ArchiveServiceClient interface {
	...
	GetQuorumVotes(ctx context.Context, in *GetQuorumVotesRequest, opts ...grpc.CallOption) (*GetQuorumVotesResponse, error)
...
func (c *archiveServiceClient) GetQuorumVotes(ctx context.Context, in *GetQuorumVotesRequest, opts ...grpc.CallOption) (*GetQuorumVotesResponse, error) {
	out := new(GetQuorumVotesResponse)
	err := c.cc.Invoke(ctx, ArchiveService_GetQuorumVotes_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ArchiveServiceServer interface {
	...
	GetQuorumVotes(context.Context, *GetQuorumVotesRequest) (*GetQuorumVotesResponse, error)
...
func (UnimplementedArchiveServiceServer) GetQuorumVotes(context.Context, *GetQuorumVotesRequest) (*GetQuorumVotesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetQuorumVotes not implemented")
}
...
func _ArchiveService_GetQuorumVotes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetQuorumVotesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ArchiveServiceServer).GetQuorumVotes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ArchiveService_GetQuorumVotes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArchiveServiceServer).GetQuorumVotes(ctx, req.(*GetQuorumVotesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ArchiveService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetQuorumVotes",
			Handler:    _ArchiveService_GetQuorumVotes_Handler,
		},
		{
