...
const (
	...
	ArchiveService_GetSendManyTransaction_FullMethodName         = "/qubic.archiver.archive.pb.ArchiveService/GetSendManyTransaction"
...
type ArchiveServiceClient interface {
	...
	GetSendManyTransaction(ctx context.Context, in *GetSendManyTransactionRequest, opts ...grpc.CallOption) (*GetSendManyTransactionResponse, error)
...
func (c *archiveServiceClient) GetSendManyTransaction(ctx context.Context, in *GetSendManyTransactionRequest, opts ...grpc.CallOption) (*GetSendManyTransactionResponse, error) {
	out := new(GetSendManyTransactionResponse)
	err := c.cc.Invoke(ctx, ArchiveService_GetSendManyTransaction_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ArchiveServiceServer interface {
	...
	GetSendManyTransaction(context.Context, *GetSendManyTransactionRequest) (*GetSendManyTransactionResponse, error)
...
func (UnimplementedArchiveServiceServer) GetSendManyTransaction(context.Context, *GetSendManyTransactionRequest) (*GetSendManyTransactionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSendManyTransaction not implemented")
}
...
func _ArchiveService_GetSendManyTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSendManyTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ArchiveServiceServer).GetSendManyTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ArchiveService_GetSendManyTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArchiveServiceServer).GetSendManyTransaction(ctx, req.(*GetSendManyTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ArchiveService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSendManyTransaction",
			Handler:    _ArchiveService_GetSendManyTransaction_Handler,
		},
		{
