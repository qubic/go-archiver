...
var file_sync_proto_goTypes = []any{
	...
	(*Transaction)(nil),                    // 11: qubic.archiver.archive.pb.Transaction
	(*TransactionStatus)(nil),              // 12: qubic.archiver.archive.pb.TransactionStatus
	(*ProcessedTickIntervalsPerEpoch)(nil), // 13: qubic.archiver.archive.pb.ProcessedTickIntervalsPerEpoch
...
var file_sync_proto_depIdxs = []int32{
	...
	9,  // 1: qubic.archiver.archive.pb.SyncEpochData.last_tick_quorum_data:type_name -> qubic.archiver.archive.pb.QuorumTickData
	10, // 2: qubic.archiver.archive.pb.SyncTickData.tick_data:type_name -> qubic.archiver.archive.pb.TickData
	9,  // 3: qubic.archiver.archive.pb.SyncTickData.quorum_data:type_name -> qubic.archiver.archive.pb.QuorumTickData
	11, // 4: qubic.archiver.archive.pb.SyncTickData.transactions:type_name -> qubic.archiver.archive.pb.Transaction
	12, // 5: qubic.archiver.archive.pb.SyncTickData.transactions_status:type_name -> qubic.archiver.archive.pb.TransactionStatus
	13, // 6: qubic.archiver.archive.pb.SyncMetadataResponse.processed_tick_intervals:type_name -> qubic.archiver.archive.pb.ProcessedTickIntervalsPerEpoch
	...
	14, // 9: qubic.archiver.archive.pb.SyncService.SyncGetBootstrapMetadata:input_type -> google.protobuf.Empty
